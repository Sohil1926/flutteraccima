...
class navMapView9 extends StatelessWidget {
  navMapView9({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(55.0, 398.0),
            child:
                // Adobe XD layer: 'stop-taking-blurry-…' (shape)
                Container(
              width: 100.0,
              height: 100.0,
              decoration: BoxDecoration(
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 31.0, 23.6),
                    size: Size(31.0, 23.6),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
          ...
          Transform.translate(
            offset: Offset(55.0, 507.0),
            child:
                // Adobe XD layer: 'medium-shot-blurry-…' (shape)
                Container(
              width: 100.0,
              height: 100.0,
              decoration: BoxDecoration(
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'photographer-865295' (shape)
                Container(
              width: 100.0,
              height: 100.0,
              decoration: BoxDecoration(
...
const String _svg_y3fkbg =
    '<svg viewBox="0.0 0.0 31.0 23.6" ><path transform="translate(0.0, -44.48)" d="M 28.50551795959473 44.47999954223633 L 9.845624923706055 63.13988494873047 L 2.494480848312378 55.78874206542969 L 0 58.28322601318359 L 9.845624923706055 68.12885284423828 L 31 46.9744758605957 L 28.50551795959473 44.47999954223633 Z" fill="#00bc48" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
