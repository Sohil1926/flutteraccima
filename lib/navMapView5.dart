...
class navMapView5 extends StatelessWidget {
  navMapView5({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 24.0, 18.3),
                    size: Size(24.0, 18.3),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
          ...
          Transform.translate(
            offset: Offset(68.0, 629.0),
            child: Text(
              '*These photos will be \nanalyzed by our AI powered \nphoto quality tester to help the \nrecruiter select the best \ncandidate for this job.',
              style: TextStyle(
                fontFamily: 'Poppins',
                fontSize: 10,
                color: const Color(0xff000000),
...
const String _svg_tk6w3x =
    '<svg viewBox="0.0 0.0 24.0 18.3" ><path transform="translate(0.0, -44.48)" d="M 22.06878852844238 44.48000335693359 L 7.622419834136963 58.92636871337891 L 1.931210994720459 53.23516082763672 L 0 55.16637420654297 L 7.622419834136963 62.78879547119141 L 24 46.41120910644531 L 22.06878852844238 44.48000335693359 Z" fill="#00bc48" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
